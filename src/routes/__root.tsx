    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-6">
      ...
      <div className="glass-card-elevated p-8 text-center max-w-sm animate-fade-in">
        ...
        <div className="relative mb-6 inline-block">
          <div className="w-24 h-24 rounded-[100px] bg-primary/10 flex items-center justify-center">
            <AlertCircle className="w-12 h-12 text-primary" />
          </div>
          <div className="absolute inset-0 rounded-[100px] -z-10 scale-110 aurora-glow opacity-50" />
        </div>
