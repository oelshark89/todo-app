  ...
  const handleSave = () => {
    if (editName.trim()) {
      updateProfile({
        ...
        avatar: editAvatar.trim() || `https://api.dicebear.com/7.x/avataaars/svg?seed=${editName}`,
    ...
    <div className="page-transition min-h-screen pb-24">
      ...
      <main className="p-4 space-y-6">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <div className="relative mb-4">
              <img
                ...
                alt={profile.name}
                className="w-28 h-28 rounded-full border-4 border-primary/20 shadow-lg"
              />
              {/* Glow effect behind avatar */}
              <div className="absolute inset-0 rounded-full aurora-glow opacity-50 -z-10 scale-110" />
        ...
        >
          ...
          <StatCard label="Pending" value={(totalTasks - completedTasks).toString()} />
        </div>
      </main>
    </div>
  )
